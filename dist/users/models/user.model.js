...
exports.User = User;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: "Foydalanuvchi unikal ID raqami" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "User1", description: "Foydalanuvchi ismi" }),
    (0, sequelize_typescript_1.Column)({
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Uzbek!$t0n", description: "Foydalanuvchi paroli" }),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "true", description: "Foydalanuvchi faolligi" }),
    (0, sequelize_typescript_1.Column)({
