...
let MachineDriverController = class MachineDriverController {
    ...
    async createMachine(createMachineDriverDto) {
        return this.machineDriverService.createMachineDriver(createMachineDriverDto);
    }
};
...
], MachineDriverController.prototype, "createMachine", null);
