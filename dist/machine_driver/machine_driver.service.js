...
exports.MachineDriverService = void 0;
const common_1 = require("@nestjs/common");
const sequelize_1 = require("@nestjs/sequelize");
const machine_driver_model_1 = require("./models/machine_driver.model");
let MachineDriverService = class MachineDriverService {
    constructor(machine_driver) {
        this.machine_driver = machine_driver;
    }
...
exports.MachineDriverService = MachineDriverService;
exports.MachineDriverService = MachineDriverService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, sequelize_1.InjectModel)(machine_driver_model_1.MachineDriver)),
    __metadata("design:paramtypes", [Object])
], MachineDriverService);
